...
export const getCathedraStatusMessage = (state: RootState) => state.cathedra.status;
export const getListOfCathedras = (state: RootState) => state.cathedra.cathedrasList;
export const getCathedraDeleteStatusMessage = (state: RootState) => state.cathedra.deleteStatus;
